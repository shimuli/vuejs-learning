<template>
  <div class="m-auto">
    <h1 class="text-3xl my-3 font-bold">Vue Calendar</h1>
    ...
    <section class="flex my-2">
      <p class="text-center font-bold" style="width:14.28%" v-for="day in days" :key="day">{{day}}</p>
    </section>
...
export default {
  ...
  methods: {
    ...
    currentDateClass(num){
      ...
      return calenderFullDate == currentFullDate ? "text-red-900" : '';
    }
  },
